---
layout: post
title: GlanceCam for iOS, iPadOS, watchOS and tvOS Terms of Service (TOS)
description:
image:
nav-menu: false
---
The GlanceCam for iOS, iPadOS, watchOS and tvOS application, components, extensions, site and services available in connection with the software application (the “App”, “GlanceCam”) are made available to you by Cesare Forelli (“I”, “Me”, or “My”) subject both to these Terms of Service and to the terms set forth in the [Privacy Policy](https://cdf1982.com/privacy/glancecamfusion_privacy_policy.html) (collectively the “Terms”). Please take a moment to review both documents before using the App.
...
You can review the most current version of the Terms of Service at any time at the URL you are currently reading this document from ([https://cdf1982.com/privacy/glancecamfusion_terms_of_service.html](https://cdf1982.com/privacy/glancecamfusion_terms_of_service.html)) and the current version of the Privacy Policy at [https://cdf1982.com/privacy/glancecamfusion_privacy_policy.html](https://cdf1982.com/privacy/glancecamfusion_privacy_policy.html).
...
GlanceCam for iOS, iPadOS, watchOS and tvOS and its subscription are a separate product from GlanceCam for Mac and do not include a license for the Mac version. GlanceCam for Mac is a separate application available on the Mac App Store and requires its own separate purchase.
<br>
<br>
<br>
**Termination**
...
GlanceCam is distributed with the following third party software. Open source components are distributed in the hope that they will be useful, but WITHOUT ANY WARRANTY, including the implied warranties of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. Their malfunction can cause the malfunction of the App.

- [MobileVLCKit](https://code.videolan.org/videolan/VLCKit) (iOS) and [TVVLCKit](https://code.videolan.org/videolan/VLCKit) (tvOS) are licensed under the [GNU Lesser General Public License version 2.1 (LGPL-2.1)](https://opensource.org/licenses/LGPL-2.1/)

- [FFmpegKit](https://github.com/arthenica/ffmpeg-kit) is licensed under the [GNU Lesser General Public License version 3.0 (LGPL-3.0)](https://opensource.org/licenses/LGPL-3.0)

- [Purchases by RevenueCat](https://github.com/RevenueCat/purchases-ios) is licensed under the [MIT License](https://opensource.org/licenses/MIT)

- [ConfettiSwiftUI](https://github.com/simibac/ConfettiSwiftUI) is licensed under the [MIT License](https://opensource.org/licenses/MIT)
...
- [Zoomable](https://github.com/cdf1982/Zoomable) is licensed under the [MIT License](https://opensource.org/licenses/MIT)
<br>
<br>
<br>
