---
layout: post
title: SendScan Terms of Service
description: Terms of Service for the SendScan application
image:
nav-menu: false
---
## Introduction
...
By downloading, accessing, or using the App, you agree to be bound by these Terms, as well as the Terms specified by Apple for the App Store, which is the sole distribution channel of SendScan.  
If you do not agree with any of these Terms, please do not use the App.
...
- The App is intended for personal productivity and document scanning; you agree not to rely on it in critical, medical, or emergency contexts.  
- You acknowledge and agree that the App, the SendScan name, its code, design, and all related intellectual property are owned by Me and protected by applicable laws.  
...
- The free version of SendScan allows unlimited scans, but limits workflow creation and execution:  
  • You cannot save new custom workflows  
  • You cannot edit or delete the default workflows  
  • You can run each default workflow up to 3 times  
- To unlock unlimited workflows and runs, you may upgrade to **SendScan Pro**, available either:  
...
## Data and Privacy
- The App stores your scanned documents and workflow configurations **locally on your device**.  
- If you enable **iCloud**, your data syncs securely via your private iCloud Drive.  
- I cannot access your iCloud data.

Please review the [Privacy Policy](https://cdf1982.com/privacy/sendscan_privacy_policy.html) for full details on how data is handled.

---

## Disclaimer of Warranties and Liability
- The App is provided **"as is"** and without warranties of any kind, express or implied.  
- I do not guarantee that the App will be error-free, uninterrupted, or suitable for your particular needs.  
- You acknowledge that data losses or sync issues between devices may occur, and you agree not to store information of economic or otherwise personally significant value in the App.  
...
- You use the App at your own risk and remain responsible for backing up your data.
...
- I reserve the right to update the App to add or remove features and supported platforms.  
- While I do not currently plan to do so, I may discontinue the App at any time, with or without notice.

---

## Applicable Law
- These Terms are governed by **Italian law**.  
- Any disputes shall be resolved exclusively in the courts of **Savona, Italy**.  
